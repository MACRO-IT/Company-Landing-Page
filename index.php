...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.php">MACRO-IT</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>We build flexible softwares</h1>
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>A smart cloud-based accounting software designed to help businesses streamline their back office operations, and automate business workflows.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">Human Resource & Payroll Software</a></h4>
              <p>A payroll management system assists in managing all your employee's financial records in a simple and automated fashion.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <h4><a href="">Loan Management Systems</a></h4>
              <p>A loan management system is a digital platform that helps automate every stage of the loan lifecycle, from application to closing and provides loan analytics data.</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            ...
            <p> We also build tailored Softwares developed specifically for a single person, company, or organization.</p>
          </div>
...
<!--
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="terms_privacy.php">Terms of service</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">cloud-based softwares</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Payments integrations</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Code Auditing</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">System Consultations</a></li>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>MACRO-IT</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
